...
var style_adm_prov__0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("IR DBD 22");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 52.150000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 52.150000 && value <= 181.310000) {
            style = [ new ol.style.Style({
